package com.community.events.dto.user;
...
/**
 * DTO for {@link com.community.events.entities.User}
 */
public class UserReadDto implements Serializable {
    ...
    public UserReadDto(Long id, String email, String lastName, String firstName, String phone, Set<RoleDto> roles) {
        this.id = id;
        this.email = email;
